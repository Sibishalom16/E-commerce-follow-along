const styles = {
  ...
  // ✅ Added comma above and corrected duplicated properties below
  form_input: "border border-gray-300 p-2 rounded-md w-full",
  form_button: "bg-blue-500 text-white px-4 py-2 rounded-md mt-2",
};
